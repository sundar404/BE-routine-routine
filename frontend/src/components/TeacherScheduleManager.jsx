                ...
                <Space direction="vertical" size="medium" style={{ width: '100%' }}>
                  ...
                  <Select
                    ...
                    filterOption={(input, option) => {
                      ...
                      // If optionText is a string, search directly
                      if (typeof optionText === 'string') {
                        return optionText.toLowerCase().includes(searchTerm);
                      }
                      
                      // For complex option content, search in teacher data
                      ...
                      if (teacher) {
                        return (
                          ...
                          (teacher.departmentId?.name || '').toLowerCase().includes(searchTerm) ||
                          (teacher.departmentId?.code || '').toLowerCase().includes(searchTerm)
                        );
                      }
                      return false;
                    }}
