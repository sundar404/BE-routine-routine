      ...
      <Space direction="vertical" size="large" style={{ width: '100%' }}>
        ...
        <Card title="📖 How to Use">
          <Space direction="vertical" size="medium">
            ...
            <div>
              <Text strong>3. Semester Group Filtering:</Text>
              <Paragraph style={{ marginLeft: '20px', marginBottom: '8px' }}>
                Use the semester group toggle to export only odd (1,3,5,7) or even (2,4,6,8) semester schedules.
              </Paragraph>
            </div>
            
            <div>
              <Text strong>4. File Format:</Text>
              <Paragraph style={{ marginLeft: '20px', marginBottom: '8px' }}>
                PDF files are saved with the format: TeacherName_Schedule_[GROUP]_YYYY-MM-DD.pdf
              </Paragraph>
            </div>
          </Space>
        </Card>

        {/* Semester Group Toggle */}
        <Card title="Semester Group Filter" style={{ marginBottom: '24px' }}>
          <SemesterGroupToggle 
            size="default"
            showLabel={true}
...
// Wrap with SemesterGroupProvider
const TeacherPDFDemoWithProvider = () => (
  <SemesterGroupProvider>
    <TeacherPDFDemo />
  </SemesterGroupProvider>
);

export default TeacherPDFDemoWithProvider;
